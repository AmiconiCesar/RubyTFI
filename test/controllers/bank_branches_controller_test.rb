...
class BankBranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_branch" do
    assert_difference("BankBranch.count") do
      post bank_branches_url, params: { bank_branch: { address: @bank_branch.address, name: @bank_branch.name, phone: @bank_branch.phone } }
    end
  ...
  test "should update bank_branch" do
    patch bank_branch_url(@bank_branch), params: { bank_branch: { address: @bank_branch.address, name: @bank_branch.name, phone: @bank_branch.phone } }
