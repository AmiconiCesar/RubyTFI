...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference("Turn.count") do
      post turns_url, params: { turn: { comment: @turn.comment, date: @turn.date, reason: @turn.reason, state: @turn.state, time: @turn.time } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { comment: @turn.comment, date: @turn.date, reason: @turn.reason, state: @turn.state, time: @turn.time } }
